...
(defcustom template-default-directories
  (cons (if (and (not (file-directory-p "~/.emacs.d/lisp/templates/"))
		 (file-directory-p "~/lib/templates"))
	    (expand-file-name "~/lib/templates/")
	  (expand-file-name "~/.emacs.d/lisp/templates/"))
...
non-nil, return nil instead (FULL \. \"~/.emacs.d/lisp/templates/DEFAULT.tpl\") if no
