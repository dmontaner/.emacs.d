...
--
--    impala-shell -k --ssl -i optbukdev-odbc.gmail.intranet:21000 -f my_script.sql
--
-- but there is a BUG in the impala-shell command  and fails if the script contains any COMMENTED lines.
-- Use ads_execute_script to avoid this BUG.
-- ads-execute-script will create a log with the output of your queries.
...
CONNECT optbukdev-odbc.gmail.intranet:21000;
USE a_copd_db;
...
--     ssh hnode
--     impala-shell -k --ssl -i optbukdev-odbc.gmail.intranet:21000
